...
class AuthConfig extends Base
{
    ...
    private function classAuthList($id){
        $module = Db::name('auth_config')->where(array('id'=>$id))->value('module');
        $where=array();
        $where['module'] = $module;
        $where['level'] = 0;
...
//        }
     ...
     * @authStatus 1
     * @author zhangxinyu
     * @createTime 2017/11/07 23:23:09
     * @qqNumber 2639347794
     *
     * @param $status 是否启用
     * @return string 状态文字
