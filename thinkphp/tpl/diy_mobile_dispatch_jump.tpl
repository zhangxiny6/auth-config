...
<head>
    ...
    <link rel="stylesheet" href="{$commonStaticsResourceUrl}/mobile/plugins/weui/lib/weui.min.css"/>
    <style>
...
<div class="page msg_success js_show">
    <div class="weui-msg">
        ...
        <?php break;?>
        <?php case 0:?>
        <img class='warm_tip_img' src="{$commonStaticsResourceUrl}/mobile/image/tips.png" />
        <!--<p class='warm_tip_title'>
            <span class="tip_title"><img class='warm_tip_img' src="{$commonStaticsResourceUrl}/mobile/image/tips.png" /><font>温馨提示</font></span>
        </p>-->
